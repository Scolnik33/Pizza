...
<body>
    ...
    <div class="w-100 vh-100 d-flex justify-content-center align-items-center">
        <form class="p-5 pt-0 pb-0" action="src/actions/signUp.php" method="post">
            ...
            <div class="d-flex flex-row justify-content-between align-items-center">
                <button type="submit" class="btn btn-warning btn-form text-light-hover">Зарегистрироваться</button>
                <a href="login.php" class="link-dark link-offset-2 link-underline-opacity-25 link-underline-opacity-100-hover">Войти</a>
            </div>
        </form>
    </div>
